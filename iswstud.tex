...
\begin{abstract}
  ...
  Aufgrund des diskreten Ansatzes werden die Randwerte der numerischen Lösung der \ac{PDE} nur an manchen Stellen exakt angenommen. Um zu erreichen, dass dies über den ganzen Rand der Fall ist, multiplizieren wir die Ansatzfunktionen mit einer Gewichtsfunktion und damit werden die Randbedingungen der \ac{PDE} automatisch erfüllt. Zusätzlich können wir dadurch die Ansatzpunkte auf dem Rand weglassen. Experimentell zeigt sich, dass die gewichtete Kernkollokation aber nur bedingt vernünftige Ergebnisse liefert, da es bei der Konstruktion der Gewichtsfunktionen für ein beliebiges Gebiet leicht passieren kann, dass in deren Ableitung Singularitäten entstehen, die zu schlechten Ergebnissen führen.
  \glsresetall
