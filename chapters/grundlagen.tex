\chapter{Kernfunktionen und reproduzierende Kern Hilberträume}
...
\begin{proof}
Einen Beweis des ersten Teils findet man in \textcite[Theorem 10.44]{Wendland.2005} und eine Beweis des zweiten Teils in \textcite[Proposition 3.14]{Santin.2017}. Der Beweis der Stetigkeit von $\lambda := \delta_x \circ D^a$ verläuft komplett analog zum Beweis von \ref{stetig}.\ref{stetig1}.
\end{proof}
