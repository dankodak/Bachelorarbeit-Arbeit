...
\end{table}
\item
Die Kernkollokation ist im Gegensatz zur \ac{FEM}, welche nur für maximal drei Dimensionen eingesetzt wird, komplett dimensionsunabhängig. Wir können ohne weiteres \acp{PDE} von Dimension vier und höher numerisch lösen.
\item
